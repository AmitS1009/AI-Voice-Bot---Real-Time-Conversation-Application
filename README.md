...
- Ensure `sample_image.png` exists in `frontend/public/`
...
- **Google Gemini Free Tier**: 15 requests/min, 1500 requests/day
- **Web Speech API**: No limits, built into browsers
- **Speech Synthesis API**: No limits, built into browsers

## 🎯 Evaluation Highlights

- ✅ **Real-time voice conversation** with child-friendly AI
- ✅ **Visual image display** as conversation context
- ✅ **Timed 1-minute interaction** with countdown
- ✅ **Tool calling** for UI feedback (animations, fun facts, emojis)
- ✅ **Engaging UX** with vibrant design and smooth interactions
- ✅ **Complete tech stack** (React + FastAPI + LLM)
...
1. **Get Google AI API Key**: Visit [Google AI Studio](https://aistudio.google.com/apikey) and create a free API key
2. **Create `.env` file**: Copy `backend/.env.example` to `backend/.env` and add your API key
3. **Run the servers**: Follow the instructions above to start backend and frontend
4. **Test it**: Open `http://localhost:5173` and start talking!

---

**Enjoy your AI conversation! 🎉**
